...
# Filter lines of a CSV file containing a specified column value
...
def FilterCSVFile(inputFile, outputFile, headerRows, column, value, delimiter):
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Filter CSV file based on one column value, keeping file header')
    ...
    parser.add_argument('-v', '--value', type=str, required=True, help='Value to select')
    ...
    FilterCSVFile(args.input, args.output, header, column, args.value, delimiter)
